...
It can also be seen that both logPower and logLength increases over time as shown from the scale on the x-axis.
...
The figures above show that the first components of both plots are greater than 35. These principal components explain 99% of the variation in both periods. The figures also show that the eigenvalues start to form a straight line after the second principal component. The first eigenvalue increased by approximately two times in the second period.
...
[10.180 4.442 1.918 1.260 0.982 0.845 0.637 0.397 0.348 0.272 0.213 0.172 0.130 0.069 0.046 0.032 0.024 0.013]
...
[10.991 4.108 1.728 1.378 1.022 0.862 0.724 0.449 0.349 0.287 0.241 0.189 0.137 0.112 0.074 0.031 0.024 0.017]
